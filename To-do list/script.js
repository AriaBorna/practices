$(document).ready(function(){
      ...
      $('.list').append(`
        <div class="item"> 
          ...
          <div class="options">
              ...
              <button class="delete">
                <svg width="25px" height="25px" viewBox="0 0 1024.00 1024.00" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#e3e3e3" stroke-width="49.152">
                ...
                <path d="M664.3 981.6H339.7c-54.2 0-98.5-43.3-99.6-97.5L223.7 235h572.9l-32.8 651.4c-2.3 53.2-46.1 95.2-99.5 95.2z" fill="#d1fffe"/>
                ...
                <path d="M827.1 239.5H193.3c-22.2 0-40.4-18.2-40.4-40.4v-2.2c0-22.2 18.2-40.4 40.4-40.4h633.8c22.2 0 40.4 18.2 40.4 40.4v2.2c0 22.2-18.2 40.4-40.4 40.4z" fill="#129900"/>
  ...
  $('.list').on('change', '.item-checkbox', function(){
    if ($(this).is(':checked')) {
      $('li').css({'color':'rgb(196, 196, 196)', 'text-decoration': 'line-through', 'text-decoration-color' : 'rgb(194, 0, 0)'})
    } else {
      $('li').css({'color':'black', 'text-decoration': 'none'})
    }
  });
});
